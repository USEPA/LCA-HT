...
public class QMatchFlowableLabel extends HarmonyQuery2Impl implements LabeledQuery {
	public static final String LABEL = "Show Flowable Label Matches";

	private String param1;
	private String[] referenceDataSets;
	private String param2;

	public QMatchFlowableLabel() {
		super();
	}
