...
//	private String comments;
	...
	public ContactMD(Resource tdbResource) {
		// this.tdbResource = tdbResource;
		// model.add(tdbResource, RDF.type, ECO.DataSource);
	}

	public ContactMD(String contactName, String contactAffiliation, String contactEmail, String contactPhone) {
		super();
...
//		this.comments = comments;
		...
		// model.add(this.tdbResource, FEDLCA.dataSourceContactName,
		// model.createTypedLiteral(this.contactName));
		// model.add(this.tdbResource, FEDLCA.dataSourceContactAffiliation,
		// model.createTypedLiteral(this.contactAffiliation));
		// model.add(this.tdbResource, FEDLCA.dataSourceContactEmail,
		// model.createTypedLiteral(this.contactEmail));
		// model.add(this.tdbResource, FEDLCA.dataSourceContactPhone,
		// model.createTypedLiteral(this.contactPhone));
	}
