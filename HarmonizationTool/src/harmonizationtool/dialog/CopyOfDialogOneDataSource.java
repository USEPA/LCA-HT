...
public class CopyOfDialogOneDataSource extends TitleAreaDialog {
...
//	private String[] referenceDataSets = null;
	...
	public CopyOfDialogOneDataSource(Shell parentShell) {
		super(parentShell);
	}
...
//	}
	...
	private QListDataSources qDataSets = new QListDataSources();
