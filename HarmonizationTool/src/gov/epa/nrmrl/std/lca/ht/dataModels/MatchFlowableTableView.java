...
public class MatchFlowableTableView extends ViewPart {
	...
	// // TableProvider tableProvider =
	// // TableKeeper.getTableProvider(tableProviderKey);
	// tableProvider.getData().get(rowNumSelected).set(colNumSelected,
	// fixedValue);
	...
	// }
	//
	// private static class HeaderMenuColumnAssignmentListener implements
	// Listener {
	//
	// @Override
	// public void handleEvent(Event event) {
	...
	// // d) NO CHANGE
	//
	// System.out.println("HeaderMenuColumnAssignmentListener event.widget  = "
	// + event.widget);
	// if (!(event.widget instanceof MenuItem)) {
	...
	// CSVColumnInfo menuCSVColumnInfo =
	...
	// return;
	// }
	// MenuItem menuItemToReset =
	// getHeaderMenuItemFromName(selectedCSVColumnInfo.getHeaderString());
	...
	// }
	// if
	// (menuCSVColumnInfo.getHeaderString().equals(selectedCSVColumnInfo.getHeaderString()))
	// {
	// // POSSIBILITY d
	...
	// } else {
	// while (matcher.find()) {
	// Issue issue = new Issue(qaCheck, i, colIndex, matcher.end(),
	// Status.WARNING);
	// Logger.getLogger("run").warn(qaCheck.getDescription());
	// Logger.getLogger("run").warn("  ->Row" + issue.getRowNumber());
	// Logger.getLogger("run").warn("  ->Column" + colIndex);
	...
	// int colCount =
	// TableKeeper.getTableProvider(tableProviderKey).getColumnCount();
	...
	// MatchFlowableTableView.tableProviderKey = tableProviderKey;
	// }
}
