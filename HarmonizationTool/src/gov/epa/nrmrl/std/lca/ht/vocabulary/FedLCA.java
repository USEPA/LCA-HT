...
public class FedLCA {
	...
	public static final Property memberOfCollection = m_model.createProperty(NS + "memberOfCollection");
...
//	public static final Resource FlowProperty = m_model.createResource(NS + "FlowProperty");
	...
	// * </p>
	// */
	// public static final Resource airLow_population_density = m_model.createResource(NS +
	// "air-low_population_density");
	//
	// /**
	// * <p>
	// * from Category_Subcategory.xlsx
	...
	// public static final Resource GoodsTransportMassDistance = m_model.createResource(NS +
	// "GoodsTransportMassDistance");
	// // Length
	...
	// public static final Resource MechanicalFiltrationTransf = m_model.createResource(NS +
	// "MechanicalFiltrationTransf");;
