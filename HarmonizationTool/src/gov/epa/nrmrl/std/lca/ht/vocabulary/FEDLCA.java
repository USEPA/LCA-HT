...
public class FEDLCA {
	...
	public static final Property hasCompartment = m_model
			.createProperty(NS + "hasCompartment");
	...
	public static final Property fromCompartment = m_model
			.createProperty(NS + "fromCompartment");
	...
	public static final Property toCompartment = m_model
			.createProperty(NS + "toCompartment");

	public static final Property localSerialNumber = m_model
			.createProperty(NS + "localSerialNumber");
...
//			.createProperty(NS + "dataSourceContactPhone");
    ...
    public static final Resource airHigh_population_density = m_model.createResource( NS + "air-high_population_density" );

    /** <p>from Category_Subcategory.xlsx</p> */
    public static final Resource airLow_population_density = m_model.createResource( NS + "air-low_population_density" );

    /** <p>from Category_Subcategory.xlsx</p> */
    public static final Resource airLow_population_densityLong_term = m_model.createResource( NS + "air-low_population_density-_long-term" );

    /** <p>from Category_Subcategory.xlsx</p> */
    public static final Resource airLower_stratosphere_upper_troposphere = m_model.createResource( NS + "air-lower_stratosphere_upper_troposphere" );
...
//  Energy/mass*time
    public static final Resource EnergyPerMass                 = m_model.createResource( NS + "EnergyPerMass");
//  Energy/area*time
    public static final Resource EnergyPerArea                 = m_model.createResource( NS + "EnergyPerArea");
//  Vehicle transport
