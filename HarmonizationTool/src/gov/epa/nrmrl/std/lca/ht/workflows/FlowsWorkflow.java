...
public class FlowsWorkflow extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		// btnMatchFlowables.setText("Unique" +
		// System.getProperty("line.separator") + "Flowables");
		btnMatchFlowables.setText("Unique "
				+ System.getProperty("line.separator") + "Flowables");
		...
		btnMatchFlowContexts.setText("Unique "
				+ System.getProperty("line.separator") + "Flow Contexts");
		...
		btnMatchFlowProperties.setText("Unique "
				+ System.getProperty("line.separator") + "Flow Properties");
	...
	private SelectionListener matchFlowablesListener = new SelectionListener() {
		private void doit(SelectionEvent e) {
			...
			CSVTableView.initializeRowMenu(2);
//			CSVTableView.hideNintyPercent();
			// JUNO THE ABOVE IS FOR FLOWABLES
		}
...
//			CSVTableView.showNintyPercent();
	...
	private SelectionListener matchFlowPropertiesListener = new SelectionListener() {
		private void doit(SelectionEvent e) {
			...
			CSVTableView.initializeRowMenu(2);
//			CSVTableView.showNintyPercent();
			// JUNO THE ABOVE IS FOR FLOW CONTEXTS
		}
