...
public class FlowsWorkflow extends ViewPart {
	...
	private static Set<Integer> uniqueFlowableRowNumbers = new HashSet<Integer>();
	private static Set<Integer> uniqueFlowContextRowNumbers = new HashSet<Integer>();
	private static Set<Integer> uniqueFlowPropertyRowNumbers = new HashSet<Integer>();

	private static Set<Integer> matchedFlowableRowNumbers = new HashSet<Integer>();
	private static Set<Integer> matchedFlowContextRowNumbers = new HashSet<Integer>();
	private static Set<Integer> matchedFlowPropertyRowNumbers = new HashSet<Integer>();
