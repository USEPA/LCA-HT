...
public class GenericConfirmBox extends TitleAreaDialog {
	...
	public GenericConfirmBox(Shell parentShell) {
		super(parentShell);
	}

	public GenericConfirmBox(Shell parentShell, String currentName) {
		super(parentShell);
